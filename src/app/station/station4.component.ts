...
class ObjStore implements Store {
...
const createObjStoreFactory = (obj: any) => new ObjStore(obj);

export const addNamedItem = (
  obj: any,
  createStore: StoreFactory = createObjStoreFactory
) => (name: string, item: any) => {
  return createStore(obj).addTo(name, item).value;
};
